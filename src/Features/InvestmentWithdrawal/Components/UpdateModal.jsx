...
import { updateInvestwithdrawal } from "../api";
import { toast, Toaster } from "sonner";

function UpdateModal({ isOpen, onClose, onUpdate, currentStatus, investmentId }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await updateInvestwithdrawal(investmentId, requestBody);
